...
/* harmony import */ var validator__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! validator */ "./node_modules/validator/index.js");
...
/* harmony import */ var tsx_form_GeneralButton__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! tsx/form/GeneralButton */ "./src/form/GeneralButton.tsx");
/* harmony import */ var tsx_component_RegionField5__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! tsx/component/RegionField5 */ "./src/component/RegionField5.tsx");
/* harmony import */ var tsx_component_TaroModal__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! tsx/component/TaroModal */ "./src/component/TaroModal.tsx");
...
/* harmony import */ var tsx_component_OperatorSelect__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! tsx/component/OperatorSelect */ "./src/component/OperatorSelect.tsx");
/* harmony import */ var img_p_loc_green_png__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! img/p/loc-green.png */ "./src/static/images/p/loc-green.png");
...
var AddressEntity = (_dec = (0,mobx_react__WEBPACK_IMPORTED_MODULE_14__.inject)('store'), _dec(_class = (0,mobx_react__WEBPACK_IMPORTED_MODULE_14__.observer)(_class = /*#__PURE__*/function (_React$Component) {
  function AddressEntity(props) {
    var _this;
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_15__["default"])(this, AddressEntity);
    _this = (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_callSuper_js__WEBPACK_IMPORTED_MODULE_16__["default"])(this, AddressEntity, [props]);
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_17__["default"])(_this, "labels0", {
      subjectId: '主体编号',
      receiptPerson: '收货人',
      receiptPhone: '联系电话',
      regionId: '地区',
    ...
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_17__["default"])(_this, "labels1", (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_18__["default"])({}, _this.labels0));
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_17__["default"])(_this, "labels", (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_18__["default"])({}, _this.labels1));
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_17__["default"])(_this, "markers", [{
      id: 0,
      //id创建多个需要不同
      iconPath: img_p_loc_green_png__WEBPACK_IMPORTED_MODULE_12__,
    ...
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_17__["default"])(_this, "opOptionType", void 0);
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_17__["default"])(_this, "currOrgType", tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_1__["default"].getAppItem('currOrgType'));
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_17__["default"])(_this, "showDetails", function () {
      var uri = '/lg/pub/receipt/address/memb/load/search?id=';
      if (_this.params.orgType != tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].ORG_TYPE_MB) uri = '/lg/pub/receipt/address/organization/load/search?id=';
      var succ = function succ(result) {
        if (tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_1__["default"].handleMessage(_this, result)) {
          ...
          var disabled = true;
          if (_this.params.mode == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].SHOW_MODE_EDIT) {
            disabled = false;
    ...
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_17__["default"])(_this, "submit", function () {
      ...
      if (!tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_1__["default"].mobileFormat(_this, receiptPhone)) {
        return;
      }
      var param = (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_18__["default"])((0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_18__["default"])({}, _this.state.entity), {}, {
      ...
      if (_this.state.mode == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].SHOW_MODE_NEW) {
        param.orgType = _this.params.orgType;
        param.operatorId = operatorId;
        param.subjectName = tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_1__["default"].getAppItem('currOrgName');
        if (_this.params.orgType == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].ORG_TYPE_MB) {
      ...
      } else if (_this.state.mode == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].SHOW_MODE_EDIT) {
        if (_this.params.orgType == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].ORG_TYPE_MB) {
      ...
      var msgs = _this.validateForm((validator__WEBPACK_IMPORTED_MODULE_19___default()), _this.labels0, param);
      if (msgs != '') {
        tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_1__["default"].showMsgBox(_this, msgs);
        return;
      }
      var succ = function succ(result) {
    ...
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_17__["default"])(_this, "search", function () {
      var receiptPerson = _this.state.receiptPerson;
      var receiptPhone = _this.state.receiptPhone;
      var regionId = _this.state.regionId;
      var detailAddress = _this.state.detailAddress;
      tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_1__["default"].go2Page(tsx_common_URI__WEBPACK_IMPORTED_MODULE_3__["default"].LOGISTICS_ADDRESS_LIST + '&mode=' + _this.params.mode + '&orgType=' + _this.params.orgType + '&receiptPerson=' + receiptPerson + '&receiptPhone=' + receiptPhone + '&regionId=' + regionId + '&detailAddress=' + detailAddress);
    });
    ...
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_17__["default"])(_this, "onInputChanged", function (name, value) {
      if (_this.state.mode != tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].SHOW_MODE_LIST) _this.validateFields(_this, (validator__WEBPACK_IMPORTED_MODULE_19___default()), name, value);
    ...
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_17__["default"])(_this, "onOpenMap", function () {
      _this.setState({
        popupMap: true
      });
    });
    ...
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_17__["default"])(_this, "onClose", function (name) {
      _this.setState((0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_17__["default"])({}, name, false));
    });
    ...
    _this.state = {
      ...
      orgType: tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].ORG_TYPE_MB,
      subjectId: '',
      subjectName: '',
      receiptPerson: '',
      receiptPhone: '',
  ...
  (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_inherits_js__WEBPACK_IMPORTED_MODULE_20__["default"])(AddressEntity, _React$Component);
  return (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_21__["default"])(AddressEntity, [{
    ...
    value: function init() {
      var _this2 = this;
      tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_1__["default"].init(this, '/lg/pub/receipt/address/memb/init/search', 'deliveryReceiptAddress').then(function (_ref) {
        var validateFields = _ref.validateFields,
          validateForm = _ref.validateForm;
        _this2.validateFields = validateFields;
        _this2.validateForm = validateForm;
      });
      if (tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].SHOW_MODE_VIEW == this.state.mode || tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].SHOW_MODE_EDIT == this.state.mode) {
        this.showDetails();
      }
    }
  }, {
    ...
    value: function getOpOptionType() {
      var opOptionType = '';
      if (this.params.orgType == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].ORG_TYPE_OP || this.params.orgType == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].ORG_TYPE_SP_G) {
        opOptionType = tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].OP_OPTION_TYPE_HQ;
      } else if (this.params.orgType == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].ORG_TYPE_SP_R) {
        opOptionType = tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].OP_OPTION_TYPE_SUPPLIER;
      } else if (this.params.orgType == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].ORG_TYPE_SS) {
        opOptionType = tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].OP_OPTION_TYPE_SERVICE_STATION;
      } else if (this.params.orgType == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].ORG_TYPE_MB || this.params.orgType == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].ORG_TYPE_SP_B) {
    ...
    value: function render() {
      ...
      var topNavBarTitle = this.params.orgType == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].ORG_TYPE_MB ? '会员收货地址' : '机构收货地址';
      var commandLabel = '提交';
      var command = this.submit;
      if (mode == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].SHOW_MODE_VIEW) {
        commandLabel = '关闭';
        command = this.goBack;
      } else if (mode == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].SHOW_MODE_LIST || mode == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].SHOW_MODE_LIST2) {
        commandLabel = '查找';
        command = this.search;
      }
      var required = '';
      if (mode == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].SHOW_MODE_NEW || mode == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].SHOW_MODE_EDIT) required = '*';
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsxs)(tsx_layout_HeadLayout__WEBPACK_IMPORTED_MODULE_5__["default"], {
        that: this,
        topNavBarTitle: topNavBarTitle,
        bottomLabel4: commandLabel,
        bottomFunc4: command,
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(tsx_view_BrView__WEBPACK_IMPORTED_MODULE_4__["default"], {
        ...
        }), this.params.orgType != tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].ORG_TYPE_MB && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(tsx_component_OperatorSelect__WEBPACK_IMPORTED_MODULE_11__["default"], {
        ...
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(tsx_view_BrView__WEBPACK_IMPORTED_MODULE_4__["default"], {
          height: tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].NUM_HEIGHT_LINE,
          backgroundColor: tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].COLOR_BACKGROUND_WHITE
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(tsx_form_GeneralInput__WEBPACK_IMPORTED_MODULE_6__["default"], {
          name: 'receiptPerson',
          ...
          height: tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].NUM_HEIGHT_LINE,
          backgroundColor: tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].COLOR_BACKGROUND_WHITE
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(tsx_component_RegionField5__WEBPACK_IMPORTED_MODULE_8__["default"], {
          mode: mode,
          ...
          height: tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].NUM_HEIGHT_LINE,
          backgroundColor: tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].COLOR_BACKGROUND_WHITE
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(tsx_form_GeneralButton__WEBPACK_IMPORTED_MODULE_7__["default"], {
          type: "primary",
          size: "mini",
          ...
          height: tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].NUM_HEIGHT_LINE,
          backgroundColor: tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].COLOR_BACKGROUND_NEAR_WHITE
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(tsx_component_TaroModal__WEBPACK_IMPORTED_MODULE_9__["default"], {
          ...
          confirmText: "\u786E\u5B9A",
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_13__.jsx)(tsx_component_MyMap__WEBPACK_IMPORTED_MODULE_10__["default"], {
            popup: true,
...
/* harmony default export */ __webpack_exports__["default"] = (AddressEntity);

/***/ }),

/***/ "./src/pkglogistics/page/logistics/AddressEntity.tsx":
/*!***********************************************************!*\
  !*** ./src/pkglogistics/page/logistics/AddressEntity.tsx ***!
  \***********************************************************/
...
/* harmony import */ var _node_modules_tarojs_taro_loader_lib_entry_cache_js_name_pkglogistics_page_logistics_AddressEntity_AddressEntity_tsx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../node_modules/@tarojs/taro-loader/lib/entry-cache.js?name=pkglogistics/page/logistics/AddressEntity!./AddressEntity.tsx */ "./node_modules/@tarojs/taro-loader/lib/entry-cache.js?name=pkglogistics/page/logistics/AddressEntity!./src/pkglogistics/page/logistics/AddressEntity.tsx");


var config = {};


var inst = Page((0,_tarojs_runtime__WEBPACK_IMPORTED_MODULE_0__.createPageConfig)(_node_modules_tarojs_taro_loader_lib_entry_cache_js_name_pkglogistics_page_logistics_AddressEntity_AddressEntity_tsx__WEBPACK_IMPORTED_MODULE_1__["default"], 'pkglogistics/page/logistics/AddressEntity', {root:{cn:[]}}, config || {}))


/* unused harmony default export */ var __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_tarojs_taro_loader_lib_entry_cache_js_name_pkglogistics_page_logistics_AddressEntity_AddressEntity_tsx__WEBPACK_IMPORTED_MODULE_1__["default"]);
