...
/* harmony import */ var tsx_common_Permissions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! tsx/common/Permissions */ "./src/common/Permissions.tsx");
...
/* harmony import */ var tsx_form_ImagePicker__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! tsx/form/ImagePicker */ "./src/form/ImagePicker.tsx");
/* harmony import */ var tsx_component_RegionField5__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! tsx/component/RegionField5 */ "./src/component/RegionField5.tsx");
...
var ServiceStationEntity = /*#__PURE__*/function (_React$Component) {
  function ServiceStationEntity(props) {
    var _this;
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_13__["default"])(this, ServiceStationEntity);
    _this = (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_callSuper_js__WEBPACK_IMPORTED_MODULE_14__["default"])(this, ServiceStationEntity, [props]);
    ...
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_15__["default"])(_this, "validateFields", void 0);
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_15__["default"])(_this, "validateForm", void 0);
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_15__["default"])(_this, "currOrgType", tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_2__["default"].getAppItem('currOrgType'));
    ...
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_15__["default"])(_this, "showDetails", function () {
      var mode = _this.state.mode;
      var id = _this.state.id;
      var createBy = _this.params.createBy;
      var orgType = _this.params.orgType;
      var param = {
        createBy: createBy
      };
      var uri = "/ss/pub/load/search?id=".concat(id);
      if (mode == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].SHOW_MODE_VIEW) {
        _this.setState({
          disabled: true
        });
      }
      var succ = function succ(result) {
        if (tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_2__["default"].handleMessage(_this, result)) {
          ...
          var orgLogoFile = [];
          orgLogoFile.push({
            url: tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_2__["default"].IMAGE_PREFIX + entity.orgLogo
          });
          var bigImageUriFile = [];
          bigImageUriFile.push({
            url: tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_2__["default"].IMAGE_PREFIX + entity.bigImageUri
          });
          var businessLicensePicFile = [];
          businessLicensePicFile.push({
            url: tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_2__["default"].IMAGE_PREFIX + entity.businessLicensePic
          });
          _this.setState({
            entity: entity,
            orgType: entity.orgType,
            orgName: entity.orgName,
            orgLogo: entity.orgLogo,
      ...
      tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_2__["default"].asyncHttpGet(_this, uri, succ, err);
    });
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_15__["default"])(_this, "submitFunc", function () {
      ...
      var orgLogo = _this.state.orgLogo;
      var legalRepresentative = _this.state.legalRepresentative;
      var contactName = _this.state.contactName;
      var bankName = _this.state.bankName;
      var contactPhone = _this.state.contactPhone;
      var bankAccount = _this.state.bankAccount;
      var detailAddress = _this.state.detailAddress;
      var bankAccountName = _this.state.bankAccountName;
      var param = (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_16__["default"])((0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_16__["default"])({}, entity), {}, {
        orgName: orgName,
        regionId: regionId,
        orgLogo: orgLogo,
        ...
        bigImageUri: _this.state.bigImageUri,
        orgType: orgType
      });
      var uri = '/ss/pub/create';
      if (_this.state.mode == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].SHOW_MODE_EDIT) {
        uri = '/ss/pub/update';
      }
      var msgs = _this.validateForm((validator__WEBPACK_IMPORTED_MODULE_17___default()), _this.labels0, param);
      if (msgs != '') {
        tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_2__["default"].showMsgBox(_this, msgs);
        return;
      }
      var succ = function succ(result) {
    ...
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_15__["default"])(_this, "onInputChanged", function (name, value) {
      if (_this.state.mode != tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].SHOW_MODE_LIST) _this.validateFields(_this, (validator__WEBPACK_IMPORTED_MODULE_17___default()), name, value);
    ...
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_15__["default"])(_this, "imageFileChanged", function (fieldName) {
      return function (value, opType, idx) {
        ...
        if ('add' == opType) {
          var succ = function succ(result) {
            ...
            if (tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_2__["default"].handleMessage(_this, result)) {
              _this.setState((0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_15__["default"])({}, fieldName, result.body));
            }
          };
          var err = function err(result) {
            if (result.statusCode) result = JSON.parse(result.data);
          ...
          tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_2__["default"].uploadSingleFile(_this, value[0].file, succ, err);
          var newValue = [];
          value[1] ? newValue.push(value[1]) : newValue.push(value[0]);
          _this.setState((0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_15__["default"])({}, fileName, newValue));
        } else if ('remove' == opType) {
          _this.setState((0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_15__["default"])({}, fileName, []));
        }
      };
    });
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_15__["default"])(_this, "setRegionId", function (regionId) {
      _this.setState({
        regionId: regionId
      });
    });
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_15__["default"])(_this, "goBack", function () {
      tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_2__["default"].goBack();
    });
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_15__["default"])(_this, "editFunc", function () {
      tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_2__["default"].go2Page(tsx_common_URI__WEBPACK_IMPORTED_MODULE_5__["default"].SUPPLIER_SUPPLIER_ENTITY + '?mode=' + tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].SHOW_MODE_EDIT + '&id=' + tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_2__["default"].getAppItem('currOrgId'));
    });
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_15__["default"])(_this, "popupMapFunc", function () {
      _this.setState({
        popupMap: true
      });
    });
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_15__["default"])(_this, "regionChanged", function (e) {
      var that = _this;
      if (e.type == 'end') {
        _this.mapCtx = _tarojs_taro__WEBPACK_IMPORTED_MODULE_1___default().createMapContext('mapContainer', _this);
    ...
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_15__["default"])(_this, "setLnL", function () {
      _this.setState({
        popupMap: false
      });
    });
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_15__["default"])(_this, "onOrgLogoChanged", function (newValue, opType, uriOrIdx) {
      var preValue = _this.state.orgLogoFile;
      var file;
      if ('add' == opType) {
        _this.setState({
          orgLogo: uriOrIdx
      ...
      _this.setState({
        orgLogoFile: newValue
      });
    });
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_15__["default"])(_this, "onBigImageChanged", function (newValue, opType, uriOrIdx) {
      var preValue = _this.state.bigImageUriFile;
      var file;
      if ('add' == opType) {
        _this.setState({
          bigImageUri: uriOrIdx
        });
      } else if ('rm' == opType) {
        _this.setState({
          bigImageUri: ''
    ...
    if (tsx_common_Permissions__WEBPACK_IMPORTED_MODULE_4__["default"].hasRole(tsx_common_Permissions__WEBPACK_IMPORTED_MODULE_4__["default"].authorities.OP_SALEMAN) && !tsx_common_Permissions__WEBPACK_IMPORTED_MODULE_4__["default"].hasRole(tsx_common_Permissions__WEBPACK_IMPORTED_MODULE_4__["default"].authorities.OP_ROOT)) {
    ...
    _this.state = {
      ...
      orgLogo: '',
      orgLogoFile: [],
      orgType: _this.params.mallType == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].MALL_TYPE_G_B2C ? tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].ORG_TYPE_SP_G : tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].ORG_TYPE_SP_R,
      orgName: '',
      businessLicenseNo: '',
      businessLicensePic: '',
  ...
  (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_inherits_js__WEBPACK_IMPORTED_MODULE_18__["default"])(ServiceStationEntity, _React$Component);
  return (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_19__["default"])(ServiceStationEntity, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;
      tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_2__["default"].init(this, '/ss/pub/init/search', 'orgnization').then(function (_ref) {
        var validateFields = _ref.validateFields,
          validateForm = _ref.validateForm;
        _this2.validateFields = validateFields;
        _this2.validateForm = validateForm;
      });
      if (this.params.createBy || tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].SHOW_MODE_VIEW == this.state.mode || tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].SHOW_MODE_EDIT == this.state.mode) {
        this.showDetails();
      }
    }
  }, {
    ...
    value: function render() {
      ...
      var prevUrl = tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_2__["default"].IMAGE_PREFIX;
      var labelKey = 'label';
      var valueKey = 'value';
      var labelWidth = tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].NUM_WIDTH_LABEL;
      var valueWidth = tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].NUM_WIDTH_VALUE;
      var topNavBarTitle = this.params.mallType == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].MALL_TYPE_R_B2C ? '本地供应商' : this.params.mallType == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].MALL_TYPE_G_B2C ? '全国供应商' : '供应商';
      ...
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsxs)(tsx_layout_HeadLayout__WEBPACK_IMPORTED_MODULE_6__["default"], {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(tsx_view_BrView__WEBPACK_IMPORTED_MODULE_7__["default"], {
          ...
          label: '*' + this.labels.legalRepresentative,
          type: 'text',
          value: this.state.legalRepresentative,
          error: this.state.errors.legalRepresentative,
          onChange: this.onInputChanged,
          disabled: disabled,
          labelWidth: labelWidth,
          valueWidth: valueWidth
          ...
          children: '*' + this.labels.orgLogo
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(tsx_form_ImagePicker__WEBPACK_IMPORTED_MODULE_10__["default"], {
          that: this,
          files: this.state.orgLogoFile,
          onChange: this.onorgLogoChanged,
          count: 1,
          category: tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].BIZZ_CAT_SUBJECT,
          disabled: disabled,
          labelWidth: labelWidth,
          valueWidth: valueWidth
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(tsx_view_BrView__WEBPACK_IMPORTED_MODULE_7__["default"], {
          ...
          children: '*' + this.labels.bigImageUri
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(tsx_form_ImagePicker__WEBPACK_IMPORTED_MODULE_10__["default"], {
          that: this,
          files: this.state.bigImageUriFile,
          onChange: this.onBigImageChanged,
          count: 1,
          category: tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].BIZZ_CAT_SUBJECT,
          disabled: disabled,
          labelWidth: labelWidth,
          ...
          onChange: this.imageFileChanged('businessLicensePic'),
          count: 1,
          category: tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].BIZZ_CAT_SUBJECT,
          disabled: disabled,
          labelWidth: labelWidth,
          ...
          height: tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].NUM_HEIGHT_LINE,
          backgroundColor: tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].COLOR_BACKGROUND_WHITE
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(tsx_component_RegionField5__WEBPACK_IMPORTED_MODULE_11__["default"], {
          mode: mode,
          ...
          name: 'detailAddress',
          label: '*' + this.labels.detailAddress,
          type: 'text',
          ...
          name: 'contactPhone',
          label: this.labels.contactPhone,
          type: 'phone',
          ...
          label: this.labels.bankAccountName,
          type: 'text',
          value: this.state.bankAccountName,
          error: this.state.errors.bankAccountName,
          onChange: this.onInputChanged,
          disabled: disabled,
          labelWidth: labelWidth,
          valueWidth: valueWidth
          ...
          height: tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].NUM_HEIGHT_LINE,
          backgroundColor: tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].COLOR_BACKGROUND_WHITE
        }), mode == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].SHOW_MODE_VIEW && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(tsx_form_GeneralInput__WEBPACK_IMPORTED_MODULE_9__["default"], {
          name: 'updateTime',
          label: this.labels.updateTime,
          type: 'text',
          value: this.state.entity ? this.state.entity.updateTime : '',
          disabled: disabled,
          labelWidth: labelWidth,
          valueWidth: valueWidth
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_12__.jsx)(tsx_view_BrView__WEBPACK_IMPORTED_MODULE_7__["default"], {
...
/* harmony default export */ __webpack_exports__["default"] = (ServiceStationEntity);

/***/ }),

/***/ "./src/pkgsubject/page/servicestation/ServiceStationEntity.tsx":
/*!*********************************************************************!*\
  !*** ./src/pkgsubject/page/servicestation/ServiceStationEntity.tsx ***!
  \*********************************************************************/
...
/* harmony import */ var _node_modules_tarojs_taro_loader_lib_entry_cache_js_name_pkgsubject_page_servicestation_ServiceStationEntity_ServiceStationEntity_tsx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../node_modules/@tarojs/taro-loader/lib/entry-cache.js?name=pkgsubject/page/servicestation/ServiceStationEntity!./ServiceStationEntity.tsx */ "./node_modules/@tarojs/taro-loader/lib/entry-cache.js?name=pkgsubject/page/servicestation/ServiceStationEntity!./src/pkgsubject/page/servicestation/ServiceStationEntity.tsx");


var config = {};


var inst = Page((0,_tarojs_runtime__WEBPACK_IMPORTED_MODULE_0__.createPageConfig)(_node_modules_tarojs_taro_loader_lib_entry_cache_js_name_pkgsubject_page_servicestation_ServiceStationEntity_ServiceStationEntity_tsx__WEBPACK_IMPORTED_MODULE_1__["default"], 'pkgsubject/page/servicestation/ServiceStationEntity', {root:{cn:[]}}, config || {}))


/* unused harmony default export */ var __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_tarojs_taro_loader_lib_entry_cache_js_name_pkgsubject_page_servicestation_ServiceStationEntity_ServiceStationEntity_tsx__WEBPACK_IMPORTED_MODULE_1__["default"]);
