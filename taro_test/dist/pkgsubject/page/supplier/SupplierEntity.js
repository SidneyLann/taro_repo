...
(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([["pkgsubject/page/supplier/SupplierEntity"],{

/***/ "./node_modules/@tarojs/taro-loader/lib/entry-cache.js?name=pkgsubject/page/supplier/SupplierEntity!./src/pkgsubject/page/supplier/SupplierEntity.tsx":
/*!************************************************************************************************************************************************************!*\
  !*** ./node_modules/@tarojs/taro-loader/lib/entry-cache.js?name=pkgsubject/page/supplier/SupplierEntity!./src/pkgsubject/page/supplier/SupplierEntity.tsx ***!
  \************************************************************************************************************************************************************/
...
var SupplierEntity = /*#__PURE__*/function (_React$Component) {
  function SupplierEntity(props) {
    var _this;
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_13__["default"])(this, SupplierEntity);
    _this = (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_callSuper_js__WEBPACK_IMPORTED_MODULE_14__["default"])(this, SupplierEntity, [props]);
    ...
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_15__["default"])(_this, "showDetails", function () {
      ...
      var uri = "/sp/pub/load/search?id=".concat(id);
      if (createBy) uri = "/sp/pub/application/search";
        ...
        if (tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_2__["default"].handleMessage(_this, result)) {
          ...
          if (createBy) {
            if (result.body.length > 0) {
              _this.setState({
                mode: tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].SHOW_MODE_EDIT
              });
              entity = result.body[0];
            } else return;
          } else entity = result.body;
          var orgLogoFile = [];
          orgLogoFile.push({
      ...
      if (_this.isSaleman) return;
      //else
      //	param.status=statuses.supplier.STATUS_APPLICATION;

      if (createBy) tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_2__["default"].asyncHttpPost(_this, uri, JSON.stringify(param), succ, err);else tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_2__["default"].asyncHttpGet(_this, uri, succ, err);
    });
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_15__["default"])(_this, "submitFunc", function () {
      ...
      var uri = '/sp/pub/create';
      if (_this.state.mode == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].SHOW_MODE_NEW) {
        if (_this.isSaleman) uri = '/sp/pub/saleman/create';
      } else if (_this.state.mode == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].SHOW_MODE_EDIT) {
        uri = '/sp/pub/global/update';
        if (_this.currOrgType == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_3__["default"].ORG_TYPE_SP_R) uri = '/sp/pub/region/update';
        if (_this.isSaleman) uri = '/sp/pub/saleman/update';else if (_this.params.createBy) uri = '/sp/pub/application/update';
      }
    ...
    _this.state = {
      ...
      businessLicensePic: '/abcdefg.jpg',
      regionId: '',
      contactName: '',
      legalRepresentative: '',
      contactPhone: '',
  ...
  (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_inherits_js__WEBPACK_IMPORTED_MODULE_18__["default"])(SupplierEntity, _React$Component);
  return (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_19__["default"])(SupplierEntity, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;
      tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_2__["default"].init(this, '/sp/pub/init/search', 'orgnization').then(function (_ref) {
...
/* harmony default export */ __webpack_exports__["default"] = (SupplierEntity);

/***/ }),

/***/ "./src/pkgsubject/page/supplier/SupplierEntity.tsx":
/*!*********************************************************!*\
  !*** ./src/pkgsubject/page/supplier/SupplierEntity.tsx ***!
  \*********************************************************/
...
/* harmony import */ var _node_modules_tarojs_taro_loader_lib_entry_cache_js_name_pkgsubject_page_supplier_SupplierEntity_SupplierEntity_tsx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../node_modules/@tarojs/taro-loader/lib/entry-cache.js?name=pkgsubject/page/supplier/SupplierEntity!./SupplierEntity.tsx */ "./node_modules/@tarojs/taro-loader/lib/entry-cache.js?name=pkgsubject/page/supplier/SupplierEntity!./src/pkgsubject/page/supplier/SupplierEntity.tsx");


var config = {};


var inst = Page((0,_tarojs_runtime__WEBPACK_IMPORTED_MODULE_0__.createPageConfig)(_node_modules_tarojs_taro_loader_lib_entry_cache_js_name_pkgsubject_page_supplier_SupplierEntity_SupplierEntity_tsx__WEBPACK_IMPORTED_MODULE_1__["default"], 'pkgsubject/page/supplier/SupplierEntity', {root:{cn:[]}}, config || {}))


/* unused harmony default export */ var __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_tarojs_taro_loader_lib_entry_cache_js_name_pkgsubject_page_supplier_SupplierEntity_SupplierEntity_tsx__WEBPACK_IMPORTED_MODULE_1__["default"]);
