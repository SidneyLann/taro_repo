...
(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([["pkgsubject/page/supplier/SupplierVisitEntity"],{

/***/ "./node_modules/@tarojs/taro-loader/lib/entry-cache.js?name=pkgsubject/page/supplier/SupplierVisitEntity!./src/pkgsubject/page/supplier/SupplierVisitEntity.tsx":
/*!**********************************************************************************************************************************************************************!*\
  !*** ./node_modules/@tarojs/taro-loader/lib/entry-cache.js?name=pkgsubject/page/supplier/SupplierVisitEntity!./src/pkgsubject/page/supplier/SupplierVisitEntity.tsx ***!
  \**********************************************************************************************************************************************************************/
...
/* harmony import */ var tsx_form_ImagePicker__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! tsx/form/ImagePicker */ "./src/form/ImagePicker.tsx");
...
var SupplierVisitEntity = /*#__PURE__*/function (_React$Component) {
  function SupplierVisitEntity(props) {
    var _this;
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_classCallCheck_js__WEBPACK_IMPORTED_MODULE_10__["default"])(this, SupplierVisitEntity);
    _this = (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_callSuper_js__WEBPACK_IMPORTED_MODULE_11__["default"])(this, SupplierVisitEntity, [props]);
    ...
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_12__["default"])(_this, "labels", (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_13__["default"])({}, _this.labels1));
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_12__["default"])(_this, "validateFields", void 0);
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_12__["default"])(_this, "validateForm", void 0);
    ...
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_12__["default"])(_this, "showDetails", function () {
      ...
      var succ = function succ(result) {
        if (tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_1__["default"].handleMessage(_this, result)) {
          ...
          intervieweeWechatQrcodeFile.push({
            url: tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_1__["default"].IMAGE_PREFIX + entity.intervieweeWechatQrcode
          });
          var supplierImageFile = [];
          supplierImageFile.push({
            url: tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_1__["default"].IMAGE_PREFIX + entity.supplierImage
          });
          ...
          intervieweeVideoFile.push({
            url: tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_1__["default"].IMAGE_PREFIX + entity.intervieweeVideo
          });
          _this.setState({
            entity: entity,
    ...
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_12__["default"])(_this, "submitFunc", function () {
      ...
      var param = (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_13__["default"])((0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_objectSpread2_js__WEBPACK_IMPORTED_MODULE_13__["default"])({}, entity), {}, {
      ...
      if (_this.state.mode == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].SHOW_MODE_NEW) param.supplierId = _this.params.supplierId;else if (_this.state.mode == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].SHOW_MODE_EDIT) uri = '/sp/pub/visit/update';
      var msgs = _this.validateForm((validator__WEBPACK_IMPORTED_MODULE_14___default()), _this.labels0, param);
      if (msgs != '') {
    ...
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_12__["default"])(_this, "onInputChanged", function (name, value) {
      if (_this.state.mode != tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].SHOW_MODE_LIST) _this.validateFields(_this, (validator__WEBPACK_IMPORTED_MODULE_14___default()), name, value);
    ...
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_12__["default"])(_this, "imageFileChanged", function (fieldName) {
      return function (value, opType, idx) {
        ...
        if ('add' == opType) {
          var succ = function succ(result) {
            ...
            if (tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_1__["default"].handleMessage(_this, result)) {
              _this.setState((0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_12__["default"])({}, fieldName, result.body));
            }
          };
          var err = function err(result) {
            if (result.statusCode) result = JSON.parse(result.data);
          ...
          tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_1__["default"].uploadSingleFile(_this, value[0].file, succ, err);
          var newValue = [];
          value[1] ? newValue.push(value[1]) : newValue.push(value[0]);
          _this.setState((0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_12__["default"])({}, fileName, newValue));
        } else if ('remove' == opType) {
          _this.setState((0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_12__["default"])({}, fileName, []));
        }
      };
    });
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_12__["default"])(_this, "goBack", function () {
      tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_1__["default"].goBack();
    });
    (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_defineProperty_js__WEBPACK_IMPORTED_MODULE_12__["default"])(_this, "editFunc", function () {
      tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_1__["default"].go2Page(tsx_common_URI__WEBPACK_IMPORTED_MODULE_3__["default"].SUPPLIER_VISIT_ENTITY + '?mode=' + tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].SHOW_MODE_EDIT + '&id=' + _this.params.id);
    });
  ...
  (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_inherits_js__WEBPACK_IMPORTED_MODULE_15__["default"])(SupplierVisitEntity, _React$Component);
  return (0,c_taro_i_bizz_client_node_modules_babel_runtime_helpers_esm_createClass_js__WEBPACK_IMPORTED_MODULE_16__["default"])(SupplierVisitEntity, [{
    key: "componentDidMount",
    value: function componentDidMount() {
      var _this2 = this;
      tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_1__["default"].init(this, '/sp/pub/visit/init/search', 'supplierVisit').then(function (_ref) {
    ...
    value: function render() {
      ...
      var topNavBarTitle = this.params.mallType == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].MALL_TYPE_R_B2C ? '本地供应商' : this.params.mallType == tsx_common_Constant__WEBPACK_IMPORTED_MODULE_2__["default"].MALL_TYPE_G_B2C ? '全国供应商' : '供应商';
      ...
      var setting = {
        subkey: tsx_common_JsUtil__WEBPACK_IMPORTED_MODULE_1__["default"].TENCENT_MAP_KEY,
        skew: 0,
        rotate: 0,
        showLocation: false,
        showScale: false,
      ...
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsxs)(tsx_layout_HeadLayout__WEBPACK_IMPORTED_MODULE_4__["default"], {
        ...
        }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_9__.jsx)(tsx_form_ImagePicker__WEBPACK_IMPORTED_MODULE_8__["default"], {
          that: this,
...
/* harmony default export */ __webpack_exports__["default"] = (SupplierVisitEntity);

/***/ }),

/***/ "./src/pkgsubject/page/supplier/SupplierVisitEntity.tsx":
/*!**************************************************************!*\
  !*** ./src/pkgsubject/page/supplier/SupplierVisitEntity.tsx ***!
  \**************************************************************/
...
/* harmony import */ var _node_modules_tarojs_taro_loader_lib_entry_cache_js_name_pkgsubject_page_supplier_SupplierVisitEntity_SupplierVisitEntity_tsx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../node_modules/@tarojs/taro-loader/lib/entry-cache.js?name=pkgsubject/page/supplier/SupplierVisitEntity!./SupplierVisitEntity.tsx */ "./node_modules/@tarojs/taro-loader/lib/entry-cache.js?name=pkgsubject/page/supplier/SupplierVisitEntity!./src/pkgsubject/page/supplier/SupplierVisitEntity.tsx");


var config = {};


var inst = Page((0,_tarojs_runtime__WEBPACK_IMPORTED_MODULE_0__.createPageConfig)(_node_modules_tarojs_taro_loader_lib_entry_cache_js_name_pkgsubject_page_supplier_SupplierVisitEntity_SupplierVisitEntity_tsx__WEBPACK_IMPORTED_MODULE_1__["default"], 'pkgsubject/page/supplier/SupplierVisitEntity', {root:{cn:[]}}, config || {}))


/* unused harmony default export */ var __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_tarojs_taro_loader_lib_entry_cache_js_name_pkgsubject_page_supplier_SupplierVisitEntity_SupplierVisitEntity_tsx__WEBPACK_IMPORTED_MODULE_1__["default"]);
